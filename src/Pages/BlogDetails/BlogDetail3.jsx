      ...
      <div className="row">
        <div className="col-sm-12 mt-5 mb-5">
          <div className="blog-content">
            ...
            <p>
              <a href="#"><i>Read Next: Being Clear About Role Expectations</i></a>
            </p>
            <p className="small">
              For information on how RHEALIZE can help your organization save money and increase worker efficiency by attracting the right people to well defined roles (right hiring), <a href="#"> contact us for a discovery call.</a>
            </p>
          </div>
        </div>
      </div>
