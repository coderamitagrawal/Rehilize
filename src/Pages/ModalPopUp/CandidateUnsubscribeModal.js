...
const CandidateUnsubscribeModal = (props) => {
  return (
    <Modal show={props.show} onHide={props.onHide} className="custom-modal-ui unsubscribe-modal" centered>
        ...
        <Modal.Body>
          ...
          Thanks for letting us know your preference, we won’t send you any further emails of this <br></br> kind and you will be removed fro our database.
          </h4>
          <h4 className='modal-text-2'>
          If you change your mind, you can sign up again at anytime to start recieving <br></br> communications again. We would love to have you back.
          </h4>
...
export default CandidateUnsubscribeModal;
